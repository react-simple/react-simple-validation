...
- **validateObject(*obj, schema, options*)**: Root entry point for validating object models.
- **vdaliteField(*field, context*)**: Used to validate single fields. Fields encapsulate field value with field type.
